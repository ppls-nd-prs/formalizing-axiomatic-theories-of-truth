...
We will also need the concept of substitution of terms in terms and formulas with a free bound variable.

\begin{definition}[substitution in terms]\label{def:subst-t}
