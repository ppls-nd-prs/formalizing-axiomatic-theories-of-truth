...
\begin{definition}[sequent calculus]\label{def:seq-calc}
    ...
    \leanok
    Let $\mathcal{L}$ be some formal language and $T_{\mathcal{L}}$ some theory of this language. Then, our calculus is the set $R$ containing the following funtions:
    \begin{enumerate}
        \item $\texttt{axL} : \mathcal{S} \to $
    \end{enumerate}
\end{definition}
