...
Now consider formula \ref{fml:db} again. We can now proof that this formula in is $\mathcal{B}(\mathcal{L}_{ex},\{2\},0)$ in the following way.
...
\begin{definition}[boundedformula to nat encoding]\label{def:coding-ttn}
